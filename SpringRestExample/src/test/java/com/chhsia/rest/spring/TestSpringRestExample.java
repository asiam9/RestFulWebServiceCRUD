package com.chhsia.rest.spring;
...
import com.chhsia.rest.model.Employee;
...
public class TestSpringRestExample {
	...
	private static void testGetDummyEmployee() {
		RestTemplate restTemplate = new RestTemplate();
		Employee emp = restTemplate.getForObject(SERVER_URI+EmployeeController.DUMMY_EMP, Employee.class);
		printEmpData(emp);
	}
